...
const STRINGS = {
  en: {
    ...
    'nav.pricing': 'Pricing',
    'nav.about': 'About',
    'landing.hero.title': 'Move freight anywhere in the UAE without living in a WhatsApp thread.',
    ...
    'landing.hero.ctaShipper': 'Post your first load',
    'landing.hero.ctaCarrier': 'Bid as a carrier',
    'landing.hero.verified': 'Verified carriers only',
    'landing.hero.autoRelease': 'Auto-released in {hours}h',
  ...
  ar: {
    ...
    'nav.pricing': 'الأسعار',
    'nav.about': 'من نحن',
    'landing.hero.title': 'انقل بضائعك في أي مكان بالإمارات دون العيش داخل محادثة واتساب.',
    'landing.hero.subtitle':
      'انشر مهمة — حاوية، حمولة مسطحة، أو توصيل بعدة شاحنات — واحصل على عروض من ناقلين موثقين عبر أربع إمارات، مع الاحتفاظ بالمبلغ في الضمان حتى تأكيد التسليم.',
    'landing.hero.ctaShipper': 'انشر أول شحنة لك',
    'landing.hero.ctaCarrier': 'قدّم عرضًا كناقل',
    'landing.hero.verified': 'ناقلون موثقون فقط',
    'landing.hero.autoRelease': 'يُصرف تلقائيًا خلال {hours} ساعة',
