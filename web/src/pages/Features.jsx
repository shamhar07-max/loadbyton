...
import { IconShield, IconClock, IconMapPin, IconFile, IconStar, IconPackage, IconTruck, IconArrowRight } from '../components/icons.jsx';
...
export default function Features() {
  ...
  useMeta('Escrow-backed drayage jobs, live tracking, contract lanes and a verified carrier network — everything Loadbyton ships.');
  return (
    <div className="container-page py-16">
      ...
      <div className="mt-16 rounded-xl px-8 py-10" style={{ background: 'var(--bg-inverse)' }}>
