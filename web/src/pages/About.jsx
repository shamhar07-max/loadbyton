...
export default function About() {
  usePageTitle('About');
  useMeta('Loadbyton is a UAE container drayage marketplace built to make the second shipment happen on-platform, not on WhatsApp.');
  return (
    <div className="container-page max-w-2xl py-16">
      ...
      <div className="mt-6 space-y-5 text-base leading-relaxed text-ink-secondary">
        <p>
          Most drayage in the UAE still moves the way it did a decade ago: a shipper with a stuck container calls around, a broker quotes a price nobody can verify against anything, and the whole arrangement lives in a WhatsApp thread that disappears the moment the truck arrives. It works, until it doesn't — and every time it works, the relationship stays off-platform.
        </p>
        <p>
